...
export default {
    ...
    getOrganizationById: (organizationId: string): string => `/admin/get-organization-details/${organizationId}`,
    verifyOrganization:(organizationId: string): string => `/admin/verify-organization/${organizationId}`,
    verifyEvent:(eventId: string): string => `/admin/verify-event/${eventId}`,
    verifyDoctor:(doctorId: string): string => `/admin/verify-doctor/${doctorId}`,
    deleteOrganization:(organizationId: string): string => `/admin/delete-organization/${organizationId}`,
    deleteEvent:(eventId: string): string => `/admin/delete-event/${eventId}`,
    deleteDoctor:(doctorId: string): string => `/admin/delete-doctor/${doctorId}`,
    ...
    respondAppointment: (appointmentId: string): string => `/appointment/respond-appointment/${appointmentId}`,
